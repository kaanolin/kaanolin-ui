...
export const Menu03 = forwardRef<SVGSVGElement, SolidIconProps>(function Menu03(
...
<path fillRule="evenodd" clipRule="evenodd" d="M2 18C2 17.4477 2.44772 17 3 17H15C15.5523 17 16 17.4477 16 18C16 18.5523 15.5523 19 15 19H3C2.44772 19 2 18.5523 2 18Z" fill="currentColor"/>
    </svg>
  );
});
