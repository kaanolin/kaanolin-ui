...
export const ClockSnooze = forwardRef<SVGSVGElement, SolidIconProps>(function ClockSnooze(
  ...
  return (
    ...
    >
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M18 19C17.4477 19 17 18.5523 17 18C17 17.4477 17.4477 17 18 17H22C22.4045 17 22.7691 17.2436 22.9239 17.6173C23.0787 17.991 22.9931 18.4211 22.7071 18.7071L20.4142 21H22C22.5523 21 23 21.4477 23 22C23 22.5523 22.5523 23 22 23H18C17.5955 23 17.2309 22.7564 17.0761 22.3827C16.9213 22.009 17.0069 21.5789 17.2929 21.2929L19.5858 19H18Z" fill="currentColor"/>
