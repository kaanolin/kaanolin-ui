...
export const IntersectSquare = forwardRef<SVGSVGElement, DuotoneIconProps>(function IntersectSquare(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M16 8V12.8C16 13.9201 16 14.4802 15.782 14.908C15.5903 15.2843 15.2843 15.5903 14.908 15.782C14.4802 16 13.9201 16 12.8 16H8V11.2C8 10.0799 8 9.51984 8.21799 9.09202C8.40973 8.71569 8.71569 8.40973 9.09202 8.21799C9.51984 8 10.0799 8 11.2 8H16Z" fill="currentColor"/>
