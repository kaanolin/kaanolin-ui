...
export const ThumbsDown = forwardRef<SVGSVGElement, DuotoneIconProps>(function ThumbsDown(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M18.8 2H17V13H18.8C19.9201 13 20.4802 13 20.908 12.782C21.2843 12.5903 21.5903 12.2843 21.782 11.908C22 11.4802 22 10.9201 22 9.8V5.2C22 4.0799 22 3.51984 21.782 3.09202C21.5903 2.71569 21.2843 2.40973 20.908 2.21799C20.4802 2 19.9201 2 18.8 2Z" fill="currentColor"/>
