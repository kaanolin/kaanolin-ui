...
export const Announcement03 = forwardRef<SVGSVGElement, DuotoneIconProps>(function Announcement03(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M22 9.5C22 13.0899 20.433 16 18.5 16C16.567 16 15 13.0899 15 9.5C15 5.91015 16.567 3 18.5 3C20.433 3 22 5.91015 22 9.5Z" fill="currentColor"/>
