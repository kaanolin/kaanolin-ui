...
export const CameraLens = forwardRef<SVGSVGElement, DuotoneIconProps>(function CameraLens(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" fillRule="evenodd" clipRule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM14.8284 14.8284C16.3905 13.2663 16.3905 10.7337 14.8284 9.17157C13.2663 7.60948 10.7337 7.60948 9.17157 9.17157C7.60948 10.7337 7.60948 13.2663 9.17157 14.8284C10.7337 16.3905 13.2663 16.3905 14.8284 14.8284Z" fill="currentColor"/>
