...
export const CameraOff = forwardRef<SVGSVGElement, DuotoneIconProps>(function CameraOff(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M16.0001 12.5C16.0001 10.2909 14.2092 8.5 12.0001 8.5C11.0216 8.5 10.1253 8.8513 9.43018 9.43464L15.0641 15.0714C15.6482 14.3761 16.0001 13.4791 16.0001 12.5Z" fill="currentColor"/>
