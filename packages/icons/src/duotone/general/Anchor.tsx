...
export const Anchor = forwardRef<SVGSVGElement, DuotoneIconProps>(function Anchor(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M12 8C13.6569 8 15 6.65685 15 5C15 3.34315 13.6569 2 12 2C10.3431 2 9 3.34315 9 5C9 6.65685 10.3431 8 12 8Z" fill="currentColor"/>
