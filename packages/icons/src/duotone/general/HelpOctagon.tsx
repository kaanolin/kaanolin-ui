...
export const HelpOctagon = forwardRef<SVGSVGElement, DuotoneIconProps>(function HelpOctagon(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M7.86 2H16.14L22 7.86V16.14L16.14 22H7.86L2 16.14V7.86L7.86 2Z" fill="currentColor"/>
