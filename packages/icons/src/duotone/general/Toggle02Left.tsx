...
export const Toggle02Left = forwardRef<SVGSVGElement, DuotoneIconProps>(function Toggle02Left(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M10.0005 16H18C20.2091 16 22 14.2091 22 12C22 9.79086 20.2091 8 18 8H10.0005C11.2147 8.91223 12 10.3644 12 12C12 13.6356 11.2147 15.0878 10.0005 16Z" fill="currentColor"/>
