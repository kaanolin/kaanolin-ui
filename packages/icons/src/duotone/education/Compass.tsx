...
export const Compass = forwardRef<SVGSVGElement, DuotoneIconProps>(function Compass(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M12 9C13.3807 9 14.5 7.88071 14.5 6.5C14.5 5.11929 13.3807 4 12 4C10.6193 4 9.5 5.11929 9.5 6.5C9.5 7.88071 10.6193 9 12 9Z" fill="currentColor"/>
