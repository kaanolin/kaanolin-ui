...
export const Microscope = forwardRef<SVGSVGElement, DuotoneIconProps>(function Microscope(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M9.5 13H5.5C5.03534 13 4.80302 13 4.60982 13.0384C3.81644 13.1962 3.19624 13.8164 3.03843 14.6098C3 14.803 3 15.0353 3 15.5C3 15.9647 3 16.197 3.03843 16.3902C3.19624 17.1836 3.81644 17.8038 4.60982 17.9616C4.80302 18 5.03534 18 5.5 18H9.5C9.96466 18 10.197 18 10.3902 17.9616C11.1836 17.8038 11.8038 17.1836 11.9616 16.3902C12 16.197 12 15.9647 12 15.5C12 15.0353 12 14.803 11.9616 14.6098C11.8038 13.8164 11.1836 13.1962 10.3902 13.0384C10.197 13 9.96466 13 9.5 13Z" fill="currentColor"/>
