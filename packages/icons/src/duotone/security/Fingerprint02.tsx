...
export const Fingerprint02 = forwardRef<SVGSVGElement, DuotoneIconProps>(function Fingerprint02(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M7.5 10C7.5 7.51472 9.51472 5.5 12 5.5C14.4853 5.5 16.5 7.51472 16.5 10V14C16.5 16.4853 14.4853 18.5 12 18.5C9.51472 18.5 7.5 16.4853 7.5 14V10Z" fill="currentColor"/>
