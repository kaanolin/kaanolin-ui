...
export const FolderShield = forwardRef<SVGSVGElement, DuotoneIconProps>(function FolderShield(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M9.02229 3H5.2C4.0799 3 3.51984 3 3.09202 3.21799C2.71569 3.40973 2.40973 3.71569 2.21799 4.09202C2 4.51984 2 5.0799 2 6.2V7H13L11.8845 4.76892C11.5634 4.1268 11.4029 3.80573 11.1634 3.57116C10.9516 3.36373 10.6963 3.20597 10.4161 3.10931C10.0992 3 9.74021 3 9.02229 3Z" fill="currentColor"/>
