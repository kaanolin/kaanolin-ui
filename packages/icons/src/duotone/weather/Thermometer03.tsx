...
export const Thermometer03 = forwardRef<SVGSVGElement, DuotoneIconProps>(function Thermometer03(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M10.5 4.5C10.5 3.11929 9.38071 2 8 2C6.61929 2 5.5 3.11929 5.5 4.5V13.7578C4.29401 14.565 3.5 15.9398 3.5 17.5C3.5 19.9853 5.51472 22 8 22C10.4853 22 12.5 19.9853 12.5 17.5C12.5 15.9398 11.706 14.565 10.5 13.7578V4.5Z" fill="currentColor"/>
