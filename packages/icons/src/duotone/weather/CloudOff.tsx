...
export const CloudOff = forwardRef<SVGSVGElement, DuotoneIconProps>(function CloudOff(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M6.5 18.9998C4.01472 18.9998 2 16.9851 2 14.4998C2 12.1562 3.79151 10.2311 6.07974 10.0192C6.24759 8.99817 6.67317 8.06399 7.28746 7.28564L18.8112 18.8058C18.3963 18.9319 17.9561 18.9998 17.5 18.9998H6.5Z" fill="currentColor"/>
