...
export const ThermometerWarm = forwardRef<SVGSVGElement, DuotoneIconProps>(function ThermometerWarm(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M16 4C16 2.89543 16.8954 2 18 2C19.1046 2 20 2.89543 20 4V14.5351C21.1956 15.2267 22 16.5194 22 18C22 20.2091 20.2091 22 18 22C15.7909 22 14 20.2091 14 18C14 16.5194 14.8044 15.2267 16 14.5351V4Z" fill="currentColor"/>
