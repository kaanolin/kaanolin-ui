...
export const Gift01 = forwardRef<SVGSVGElement, DuotoneIconProps>(function Gift01(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M20 18.8V11H4V18.8C4 19.9201 4 20.4802 4.21799 20.908C4.40973 21.2843 4.71569 21.5903 5.09202 21.782C5.51984 22 6.07989 22 7.2 22L16.8 22C17.9201 22 18.4802 22 18.908 21.782C19.2843 21.5903 19.5903 21.2843 19.782 20.908C20 20.4802 20 19.9201 20 18.8Z" fill="currentColor"/>
