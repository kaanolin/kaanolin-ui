...
export const CreditCardDownload = forwardRef<SVGSVGElement, DuotoneIconProps>(function CreditCardDownload(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M2 7.2V9H22V7.2C22 6.0799 22 5.51984 21.782 5.09202C21.5903 4.7157 21.2843 4.40974 20.908 4.21799C20.4802 4 19.9201 4 18.8 4H5.2C4.0799 4 3.51984 4 3.09202 4.21799C2.7157 4.40973 2.40973 4.71569 2.21799 5.09202C2 5.51984 2 6.07989 2 7.2Z" fill="currentColor"/>
