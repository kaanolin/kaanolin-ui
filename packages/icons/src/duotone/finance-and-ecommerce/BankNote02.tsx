...
export const BankNote02 = forwardRef<SVGSVGElement, DuotoneIconProps>(function BankNote02(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M12 14.5C13.3807 14.5 14.5 13.3807 14.5 12C14.5 10.6193 13.3807 9.5 12 9.5C10.6193 9.5 9.5 10.6193 9.5 12C9.5 13.3807 10.6193 14.5 12 14.5Z" fill="currentColor"/>
