...
export const CoinsStacked01 = forwardRef<SVGSVGElement, DuotoneIconProps>(function CoinsStacked01(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M17 22C19.7614 22 22 19.7614 22 17C22 14.2386 19.7614 12 17 12C14.2386 12 12 14.2386 12 17C12 19.7614 14.2386 22 17 22Z" fill="currentColor"/>
