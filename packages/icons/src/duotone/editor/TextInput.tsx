...
export const TextInput = forwardRef<SVGSVGElement, DuotoneIconProps>(function TextInput(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M18.8 7H17V17H18.8C19.9201 17 20.4802 17 20.908 16.782C21.2843 16.5903 21.5903 16.2843 21.782 15.908C22 15.4802 22 14.9201 22 13.8V10.2C22 9.0799 22 8.51984 21.782 8.09202C21.5903 7.71569 21.2843 7.40973 20.908 7.21799C20.4802 7 19.9201 7 18.8 7Z" fill="currentColor"/>
