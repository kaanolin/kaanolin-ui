...
export const Feather = forwardRef<SVGSVGElement, DuotoneIconProps>(function Feather(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M9 15H18L14.4686 18.5314C14.2957 18.7043 14.2092 18.7908 14.1083 18.8526C14.0188 18.9075 13.9213 18.9479 13.8192 18.9724C13.7041 19 13.5818 19 13.3373 19H5L9 15Z" fill="currentColor"/>
