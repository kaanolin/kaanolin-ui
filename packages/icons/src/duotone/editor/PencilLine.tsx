...
export const PencilLine = forwardRef<SVGSVGElement, DuotoneIconProps>(function PencilLine(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M4.55809 16.1488C4.70537 15.7659 4.77901 15.5745 4.90531 15.4868C5.01569 15.4101 5.15228 15.3811 5.28427 15.4063C5.43531 15.4352 5.58036 15.5802 5.87046 15.8703L8.12955 18.1294C8.41964 18.4195 8.56469 18.5646 8.59354 18.7156C8.61874 18.8476 8.58976 18.9842 8.51312 19.0946C8.42542 19.2209 8.23396 19.2945 7.85104 19.4418L2.5 21.4999L4.55809 16.1488Z" fill="currentColor"/>
