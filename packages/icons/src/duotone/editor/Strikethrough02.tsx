...
export const Strikethrough02 = forwardRef<SVGSVGElement, DuotoneIconProps>(function Strikethrough02(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M14 20C16.2091 20 18 18.2091 18 16C18 13.7909 16.2091 12 14 12H10.5C12.7091 12 14.5 13.7909 14.5 16C14.5 18.2091 12.7091 20 10.5 20H14Z" fill="currentColor"/>
