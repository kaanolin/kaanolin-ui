...
export const Figma = forwardRef<SVGSVGElement, DuotoneIconProps>(function Figma(
  ...
  return (
    ...
    >
      ...
      <g opacity="0.12">
<path d="M5 5C5 3.067 6.567 1.5 8.5 1.5H12V8.5H8.5C6.567 8.5 5 6.933 5 5Z" fill="currentColor"/>
<path d="M5 19C5 17.067 6.567 15.5 8.5 15.5H12V19C12 20.933 10.433 22.5 8.5 22.5C6.567 22.5 5 20.933 5 19Z" fill="currentColor"/>
<path d="M12 12C12 10.067 13.567 8.5 15.5 8.5C17.433 8.5 19 10.067 19 12C19 13.933 17.433 15.5 15.5 15.5C13.567 15.5 12 13.933 12 12Z" fill="currentColor"/>
</g>
