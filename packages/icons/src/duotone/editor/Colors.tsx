...
export const Colors = forwardRef<SVGSVGElement, DuotoneIconProps>(function Colors(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M13.5798 13.7896C13.0765 13.9267 12.5468 13.9998 12 13.9998C9.46679 13.9998 7.30024 12.4299 6.42018 10.21C3.87293 10.9034 2 13.2329 2 15.9998C2 19.3135 4.68629 21.9998 8 21.9998C11.3137 21.9998 14 19.3135 14 15.9998C14 15.2193 13.851 14.4736 13.5798 13.7896Z" fill="currentColor"/>
