...
export const Tram = forwardRef<SVGSVGElement, DuotoneIconProps>(function Tram(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M4 13H20V15.2C20 16.8802 20 17.7202 19.673 18.362C19.3854 18.9265 18.9265 19.3854 18.362 19.673C17.7202 20 16.8802 20 15.2 20H8.8C7.11984 20 6.27976 20 5.63803 19.673C5.07354 19.3854 4.6146 18.9265 4.32698 18.362C4 17.7202 4 16.8802 4 15.2V13Z" fill="currentColor"/>
