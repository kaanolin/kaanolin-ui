...
export const Train = forwardRef<SVGSVGElement, DuotoneIconProps>(function Train(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M4 12H20V14.2C20 15.8802 20 16.7202 19.673 17.362C19.3854 17.9265 18.9265 18.3854 18.362 18.673C17.7202 19 16.8802 19 15.2 19H8.8C7.11984 19 6.27976 19 5.63803 18.673C5.07354 18.3854 4.6146 17.9265 4.32698 17.362C4 16.7202 4 15.8802 4 14.2V12Z" fill="currentColor"/>
