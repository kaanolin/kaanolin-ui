...
export const Passport = forwardRef<SVGSVGElement, DuotoneIconProps>(function Passport(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M12 12C13.6569 12 15 10.6569 15 9C15 7.34315 13.6569 6 12 6C10.3431 6 9 7.34315 9 9C9 10.6569 10.3431 12 12 12Z" fill="currentColor"/>
