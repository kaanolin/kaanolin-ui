...
export const ArrowSquareDownRight = forwardRef<SVGSVGElement, DuotoneIconProps>(function ArrowSquareDownRight(
  ...
  return (
    ...
    >
      ...
      <rect opacity="0.12" x="3" y="3" width="18" height="18" fill="currentColor"/>
