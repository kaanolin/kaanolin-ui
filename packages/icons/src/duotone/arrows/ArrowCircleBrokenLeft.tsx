...
export const ArrowCircleBrokenLeft = forwardRef<SVGSVGElement, DuotoneIconProps>(function ArrowCircleBrokenLeft(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M2 12C2 17.5228 6.47715 22 12 22C15.7014 22 18.9331 19.989 20.6622 17V7C18.9331 4.01099 15.7014 2 12 2C6.47715 2 2 6.47715 2 12Z" fill="currentColor"/>
