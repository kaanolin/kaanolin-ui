...
export const MusicNotePlus = forwardRef<SVGSVGElement, DuotoneIconProps>(function MusicNotePlus(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M11.5 21C13.1569 21 14.5 19.6569 14.5 18C14.5 16.3431 13.1569 15 11.5 15C9.84315 15 8.5 16.3431 8.5 18C8.5 19.6569 9.84315 21 11.5 21Z" fill="currentColor"/>
