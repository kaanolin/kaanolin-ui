...
export const Podcast = forwardRef<SVGSVGElement, DuotoneIconProps>(function Podcast(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M10 18C10 16.8954 10.8954 16 12 16C13.1046 16 14 16.8954 14 18V20C14 21.1046 13.1046 22 12 22C10.8954 22 10 21.1046 10 20V18Z" fill="currentColor"/>
