...
export const VideoRecorderOff = forwardRef<SVGSVGElement, DuotoneIconProps>(function VideoRecorderOff(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M5 19H14C15.3527 19 16.4962 18.1048 16.8705 16.8745L5 5C3.34315 5 2 6.34315 2 8V16C2 17.6569 3.34315 19 5 19Z" fill="currentColor" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
