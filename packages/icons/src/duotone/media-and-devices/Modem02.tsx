...
export const Modem02 = forwardRef<SVGSVGElement, DuotoneIconProps>(function Modem02(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M2 18.2C2 17.0799 2 16.5198 2.21799 16.092C2.40973 15.7157 2.71569 15.4097 3.09202 15.218C3.51984 15 4.07989 15 5.2 15H18.8C19.9201 15 20.4802 15 20.908 15.218C21.2843 15.4097 21.5903 15.7157 21.782 16.092C22 16.5198 22 17.0799 22 18.2V18.8C22 19.9201 22 20.4802 21.782 20.908C21.5903 21.2843 21.2843 21.5903 20.908 21.782C20.4802 22 19.9201 22 18.8 22H5.2C4.0799 22 3.51984 22 3.09202 21.782C2.71569 21.5903 2.40973 21.2843 2.21799 20.908C2 20.4802 2 19.9201 2 18.8V18.2Z" fill="currentColor"/>
