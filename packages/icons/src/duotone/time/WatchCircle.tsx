...
export const WatchCircle = forwardRef<SVGSVGElement, DuotoneIconProps>(function WatchCircle(
  ...
  return (
    ...
    >
      ...
      <g opacity="0.12">
<path d="M16.899 17C15.6364 18.2372 13.9073 19 12 19C10.0927 19 8.36355 18.2372 7.10102 17H7L7.48551 19.4276C7.66878 20.3439 7.76041 20.8021 7.99964 21.1448C8.2106 21.447 8.50097 21.685 8.83869 21.8326C9.22166 22 9.6889 22 10.6234 22H13.3766C14.3111 22 14.7783 22 15.1613 21.8326C15.499 21.685 15.7894 21.447 16.0004 21.1448C16.2396 20.8021 16.3312 20.3439 16.5145 19.4276L17 17H16.899Z" fill="currentColor"/>
<path d="M16.5145 4.57243C16.3312 3.6561 16.2396 3.19793 16.0004 2.85522C15.7894 2.55301 15.499 2.31497 15.1613 2.16737C14.7783 2 14.3111 2 13.3766 2H10.6234C9.6889 2 9.22166 2 8.83869 2.16737C8.50097 2.31497 8.2106 2.55301 7.99964 2.85522C7.76041 3.19793 7.66878 3.6561 7.48551 4.57243L7 7H7.10102C8.36355 5.76281 10.0927 5 12 5C13.9073 5 15.6364 5.76281 16.899 7H17L16.5145 4.57243Z" fill="currentColor"/>
</g>
