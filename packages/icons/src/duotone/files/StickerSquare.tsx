...
export const StickerSquare = forwardRef<SVGSVGElement, DuotoneIconProps>(function StickerSquare(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M14.3657 4.36561C13.9373 3.93724 13.7231 3.72305 13.5392 3.70858C13.3797 3.69602 13.2237 3.76061 13.1198 3.88231C13 4.02257 13 4.32548 13 4.9313V6.19993C13 7.88008 13 8.72016 13.327 9.3619C13.6146 9.92638 14.0735 10.3853 14.638 10.6729C15.2798 10.9999 16.1198 10.9999 17.8 10.9999H19.0686" fill="currentColor"/>
