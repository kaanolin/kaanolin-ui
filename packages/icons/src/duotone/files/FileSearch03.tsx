...
export const FileSearch03 = forwardRef<SVGSVGElement, DuotoneIconProps>(function FileSearch03(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.12" d="M12 18C13.933 18 15.5 16.433 15.5 14.5C15.5 12.567 13.933 11 12 11C10.067 11 8.5 12.567 8.5 14.5C8.5 16.433 10.067 18 12 18Z" fill="currentColor"/>
