...
export const PaymentMaestroSm = forwardRef<SVGSVGElement, IconBaseProps>(function PaymentMaestroSm(
...
<path fillRule="evenodd" clipRule="evenodd" d="M16.9286 6.60193C18.3539 7.83189 19.2576 9.66205 19.2576 11.7057C19.2576 13.7494 18.3539 15.5796 16.9286 16.8096C15.5034 15.5796 14.5996 13.7494 14.5996 11.7057C14.5996 9.66205 15.5034 7.83189 16.9286 6.60193Z" fill="#6C6BBD"/>
    </svg>
  );
});
PaymentMaestroSm.displayName = "PaymentMaestroSm";
