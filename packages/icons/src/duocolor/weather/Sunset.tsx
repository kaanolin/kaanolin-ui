...
export const Sunset = forwardRef<SVGSVGElement, DuocolorIconProps>(function Sunset(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M16 5L12 9M12 9L8 5M12 9V2" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
