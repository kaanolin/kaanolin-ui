...
export const ShieldTick = forwardRef<SVGSVGElement, DuocolorIconProps>(function ShieldTick(
...
<path d="M9 11.5L11 13.5L15.5 9" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
