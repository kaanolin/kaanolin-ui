...
export const ShieldPlus = forwardRef<SVGSVGElement, DuocolorIconProps>(function ShieldPlus(
...
<path d="M12 14.5V8.5M9 11.5H15" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
