...
export const BellMinus = forwardRef<SVGSVGElement, DuocolorIconProps>(function BellMinus(
...
<path d="M9.35413 21C10.0593 21.6224 10.9855 22 12 22C13.0144 22 13.9406 21.6224 14.6458 21M15 5H21" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
