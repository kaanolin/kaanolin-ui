...
export const GitMerge = forwardRef<SVGSVGElement, DuocolorIconProps>(function GitMerge(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M6 21V9C6 11.3869 6.94821 13.6761 8.63604 15.364C10.3239 17.0518 12.6131 18 15 18" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
