...
export const TerminalCircle = forwardRef<SVGSVGElement, DuocolorIconProps>(function TerminalCircle(
...
<path d="M7 15L10 12L7 9M13 15L17 15" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
