...
export const Target05 = forwardRef<SVGSVGElement, DuocolorIconProps>(function Target05(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18Z" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
