...
export const Home04 = forwardRef<SVGSVGElement, DuocolorIconProps>(function Home04(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M12 16C13.6569 16 15 14.6569 15 13C15 11.3431 13.6569 10 12 10C10.3431 10 9 11.3431 9 13C9 14.6569 10.3431 16 12 16Z" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
