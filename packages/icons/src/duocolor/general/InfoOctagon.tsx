...
export const InfoOctagon = forwardRef<SVGSVGElement, DuocolorIconProps>(function InfoOctagon(
...
<path d="M12 16V12M12 8H12.01" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
