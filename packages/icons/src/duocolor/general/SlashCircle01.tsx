...
export const SlashCircle01 = forwardRef<SVGSVGElement, DuocolorIconProps>(function SlashCircle01(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M4.92999 4.92999L19.07 19.07" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
