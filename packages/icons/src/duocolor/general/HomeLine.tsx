...
export const HomeLine = forwardRef<SVGSVGElement, DuocolorIconProps>(function HomeLine(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M8 17H16" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
