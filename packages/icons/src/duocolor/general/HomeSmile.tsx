...
export const HomeSmile = forwardRef<SVGSVGElement, DuocolorIconProps>(function HomeSmile(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M8.12601 14C8.57005 15.7252 10.1361 17 12 17C13.8638 17 15.4299 15.7252 15.874 14" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
