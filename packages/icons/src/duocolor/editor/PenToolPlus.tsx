...
export const PenToolPlus = forwardRef<SVGSVGElement, DuocolorIconProps>(function PenToolPlus(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M5 8V2M2 5H8" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
