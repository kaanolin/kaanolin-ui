...
export const LayoutBottom = forwardRef<SVGSVGElement, DuocolorIconProps>(function LayoutBottom(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M3 15H21" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
