...
export const LayoutLeft = forwardRef<SVGSVGElement, DuocolorIconProps>(function LayoutLeft(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M9 3V21" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
