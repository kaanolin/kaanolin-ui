...
export const LayoutRight = forwardRef<SVGSVGElement, DuocolorIconProps>(function LayoutRight(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M15 3V21" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
