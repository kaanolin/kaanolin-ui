...
export const GridDotsOuter = forwardRef<SVGSVGElement, DuocolorIconProps>(function GridDotsOuter(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M7.5 12H7.51M16.5 12H16.51M12 12H12.01M12 16.5H12.01M12 7.5H12.01" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
