...
export const LayoutTop = forwardRef<SVGSVGElement, DuocolorIconProps>(function LayoutTop(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M3 9H21" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
