...
export const PauseCircle = forwardRef<SVGSVGElement, DuocolorIconProps>(function PauseCircle(
...
<path d="M9.5 15V9M14.5 15V9" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
