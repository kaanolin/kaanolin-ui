...
export const VolumeMax = forwardRef<SVGSVGElement, DuocolorIconProps>(function VolumeMax(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M19.748 5C21.1653 6.97024 22.0001 9.38763 22.0001 12C22.0001 14.6124 21.1653 17.0298 19.748 19M15.7454 8C16.5362 9.13383 17.0001 10.5128 17.0001 12C17.0001 13.4872 16.5362 14.8662 15.7454 16" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
