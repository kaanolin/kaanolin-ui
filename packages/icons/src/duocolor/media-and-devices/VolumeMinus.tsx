...
export const VolumeMinus = forwardRef<SVGSVGElement, DuocolorIconProps>(function VolumeMinus(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M15 12H22" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
