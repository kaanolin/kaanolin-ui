...
export const BatteryEmpty = forwardRef<SVGSVGElement, DuocolorIconProps>(function BatteryEmpty(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M22 13V11" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
