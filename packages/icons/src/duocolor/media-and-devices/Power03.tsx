...
export const Power03 = forwardRef<SVGSVGElement, DuocolorIconProps>(function Power03(
...
<path d="M12 7L12 17" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
