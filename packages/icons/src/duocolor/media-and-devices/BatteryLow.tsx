...
export const BatteryLow = forwardRef<SVGSVGElement, DuocolorIconProps>(function BatteryLow(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M6.5 10V14M22 13V11" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
