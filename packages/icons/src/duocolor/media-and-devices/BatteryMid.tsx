...
export const BatteryMid = forwardRef<SVGSVGElement, DuocolorIconProps>(function BatteryMid(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M6.5 10V14M10.5 10V14M22 13V11" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
