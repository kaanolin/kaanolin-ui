...
export const AnnotationPlus = forwardRef<SVGSVGElement, DuocolorIconProps>(function AnnotationPlus(
...
<path d="M12 13.5V7.5M9 10.5H15" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
});
AnnotationPlus.displayName = "AnnotationPlus";
