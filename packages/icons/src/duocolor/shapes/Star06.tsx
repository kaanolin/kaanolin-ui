...
export const Star06 = forwardRef<SVGSVGElement, DuocolorIconProps>(function Star06(
  ...
  return (
    ...
    >
      ...
      <path opacity="0.4" d="M4.5 7V4.5M4.5 4.5V2M4.5 4.5H2M4.5 4.5H7M4.5 22V19.5M4.5 19.5V17M4.5 19.5H2M4.5 19.5H7" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
