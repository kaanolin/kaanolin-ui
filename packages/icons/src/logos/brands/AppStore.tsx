...
export const AppStore = forwardRef<SVGSVGElement, IconBaseProps>(function AppStore(
  ...
  return (
    ...
    >
      ...
      <circle cx="16" cy="16" r="14" fill={`url(#${uid}-paint0_linear_1334_1796)`}/>
...
<defs>
<linearGradient id={`${uid}-paint0_linear_1334_1796`} x1="16" y1="2" x2="16" y2="30" gradientUnits="userSpaceOnUse">
