...
export const Framer = forwardRef<SVGSVGElement, IconBaseProps>(function Framer(
...
<path fillRule="evenodd" clipRule="evenodd" d="M9 20.3334H16V27L9 20.3334Z" fill="#0055FF"/>
