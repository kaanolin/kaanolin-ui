...
export const FbMessenger = forwardRef<SVGSVGElement, IconBaseProps>(function FbMessenger(
  ...
  return (
    ...
    >
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M16 28.1791C23.1797 28.1791 29 22.5426 29 15.5896C29 8.63654 23.1797 3 16 3C8.8203 3 3 8.63654 3 15.5896C3 19.3712 4.72168 22.7634 7.44737 25.0711V27.6188C7.44737 28.6145 8.4616 29.2824 9.36588 28.8821L12.193 27.6307C13.397 27.9873 14.6754 28.1791 16 28.1791Z" fill={`url(#${uid}-paint0_linear_1334_749)`}/>
...
<defs>
<linearGradient id={`${uid}-paint0_linear_1334_749`} x1="16" y1="3" x2="11.8286" y2="28.8583" gradientUnits="userSpaceOnUse">
...
FbMessenger.displayName = "FbMessenger";
