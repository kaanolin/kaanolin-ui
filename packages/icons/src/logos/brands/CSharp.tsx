...
export const CSharp = forwardRef<SVGSVGElement, IconBaseProps>(function CSharp(
  ...
  return (
    ...
    >
      ...
      <path d="M27.6947 23C27.883 22.6618 28 22.2808 28 21.9386V10.0614C28 9.71919 27.8831 9.33824 27.6947 9.00006L16 16L27.6947 23Z" fill="#7F3A86"/>
<path d="M17.0386 29.7433L26.9601 23.8047C27.2459 23.6336 27.5057 23.3382 27.694 23L15.9994 16L4.30469 23C4.493 23.3382 4.75284 23.6337 5.03857 23.8047L14.9601 29.7433C15.5317 30.0855 16.467 30.0855 17.0386 29.7433Z" fill="#662579"/>
