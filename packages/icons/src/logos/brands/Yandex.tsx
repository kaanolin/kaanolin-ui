...
export const Yandex = forwardRef<SVGSVGElement, IconBaseProps>(function Yandex(
  ...
  return (
    ...
    >
      ...
      <path d="M2 16C2 8.26801 8.26801 2 16 2C23.732 2 30 8.26801 30 16C30 23.732 23.732 30 16 30C8.26801 30 2 23.732 2 16Z" fill="white"/>
