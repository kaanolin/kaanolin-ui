...
export const MsExcel = forwardRef<SVGSVGElement, IconBaseProps>(function MsExcel(
...
<path d="M8 23H32V28C32 29.1046 31.1046 30 30 30H10C8.89543 30 8 29.1046 8 28V23Z" fill={`url(#${uid}-paint0_linear_1334_1190)`}/>
...
<rect y="7" width="18" height="18" rx="2" fill={`url(#${uid}-paint1_linear_1334_1190)`}/>
...
<defs>
<linearGradient id={`${uid}-paint0_linear_1334_1190`} x1="8" y1="26.5" x2="32" y2="26.5" gradientUnits="userSpaceOnUse">
<stop stopColor="#163C27"/>
<stop offset="1" stopColor="#2A6043"/>
</linearGradient>
<linearGradient id={`${uid}-paint1_linear_1334_1190`} x1="0" y1="16" x2="18" y2="16" gradientUnits="userSpaceOnUse">
