...
export const MsSharepoint = forwardRef<SVGSVGElement, IconBaseProps>(function MsSharepoint(
  ...
  return (
    ...
    >
      ...
      <circle cx="15.5" cy="11.5" r="9.5" fill={`url(#${uid}-paint0_linear_1334_1245)`}/>
<circle cx="24" cy="17" r="8" fill={`url(#${uid}-paint1_linear_1334_1245)`}/>
<mask id={`${uid}-mask0_1334_1245`} style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="10" y="6" width="13" height="24">
...
<g mask={`url(#${uid}-mask0_1334_1245)`}>
<circle cx="16.5" cy="23.5" r="6.5" fill={`url(#${uid}-paint2_linear_1334_1245)`}/>
...
<rect y="7" width="18" height="18" rx="2" fill={`url(#${uid}-paint3_linear_1334_1245)`}/>
...
<defs>
<linearGradient id={`${uid}-paint0_linear_1334_1245`} x1="6" y1="11.5" x2="26.5833" y2="11.5" gradientUnits="userSpaceOnUse">
<stop stopColor="#103A3B"/>
<stop offset="1" stopColor="#116B6E"/>
</linearGradient>
<linearGradient id={`${uid}-paint1_linear_1334_1245`} x1="18" y1="13" x2="32" y2="21" gradientUnits="userSpaceOnUse">
<stop stopColor="#1D9097"/>
<stop offset="1" stopColor="#29BBC2"/>
</linearGradient>
<linearGradient id={`${uid}-paint2_linear_1334_1245`} x1="12" y1="21.5" x2="23" y2="26.5" gradientUnits="userSpaceOnUse">
<stop stopColor="#28A6B5"/>
<stop offset="1" stopColor="#31D6EC"/>
</linearGradient>
<linearGradient id={`${uid}-paint3_linear_1334_1245`} x1="0" y1="16" x2="19.5" y2="16" gradientUnits="userSpaceOnUse">
...
MsSharepoint.displayName = "MsSharepoint";
