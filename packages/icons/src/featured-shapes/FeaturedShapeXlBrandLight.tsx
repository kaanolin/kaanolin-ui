...
export const FeaturedShapeXlBrandLight = forwardRef<SVGSVGElement, FeaturedProps>(function FeaturedShapeXlBrandLight(
...
FeaturedShapeXlBrandLight.displayName = "FeaturedShapeXlBrandLight";
