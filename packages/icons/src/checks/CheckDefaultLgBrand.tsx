...
export const CheckDefaultLgBrand = forwardRef<SVGSVGElement, IconBaseProps>(function CheckDefaultLgBrand(
...
CheckDefaultLgBrand.displayName = "CheckDefaultLgBrand";
