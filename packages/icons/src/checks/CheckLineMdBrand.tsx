...
export const CheckLineMdBrand = forwardRef<SVGSVGElement, IconBaseProps>(function CheckLineMdBrand(
...
CheckLineMdBrand.displayName = "CheckLineMdBrand";
