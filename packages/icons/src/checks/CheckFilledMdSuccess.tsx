...
export const CheckFilledMdSuccess = forwardRef<SVGSVGElement, IconBaseProps>(function CheckFilledMdSuccess(
...
CheckFilledMdSuccess.displayName = "CheckFilledMdSuccess";
