...
export const Star_0Gray = forwardRef<SVGSVGElement, IconBaseProps>(function Star_0Gray(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_3304_471165)`}>
...
<defs>
<clipPath id={`${uid}-clip0_3304_471165`}>
...
Star_0Gray.displayName = "Star_0Gray";
