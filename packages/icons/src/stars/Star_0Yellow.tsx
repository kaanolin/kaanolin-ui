...
export const Star_0Yellow = forwardRef<SVGSVGElement, IconBaseProps>(function Star_0Yellow(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_1232_82)`}>
...
Star_0Yellow.displayName = "Star_0Yellow";
