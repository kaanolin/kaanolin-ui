...
export const Gabon = forwardRef<SVGSVGElement, FlagProps>(function Gabon(
  { size = 24, shape = "circle", title, "aria-label": ariaLabel, ...rest },
  ref,
) {
  const shapes: Partial<Record<FlagShape, { viewBox: string; body: ReactNode }>> = {
    circle: { viewBox: "0 0 20 20", body: <><path d="M19.378 13.4782C19.78 12.3949 20 11.2232 20 9.99997C20 8.77677 19.78 7.60509 19.378 6.52173L10 5.65216L0.621992 6.52173C0.220039 7.60509 0 8.77677 0 9.99997C0 11.2232 0.220039 12.3949 0.621992 13.4782L10 14.3478L19.378 13.4782Z" fill="#FFDA44"/>
<path d="M9.99914 20C14.2987 20 17.9642 17.2863 19.3771 13.4783H0.621094C2.03406 17.2863 5.69945 20 9.99914 20Z" fill="#0052B4"/>
