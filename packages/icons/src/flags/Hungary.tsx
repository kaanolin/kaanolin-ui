...
export const Hungary = forwardRef<SVGSVGElement, FlagProps>(function Hungary(
  { size = 24, shape = "circle", title, "aria-label": ariaLabel, ...rest },
  ref,
) {
  const shapes: Partial<Record<FlagShape, { viewBox: string; body: ReactNode }>> = {
    circle: { viewBox: "0 0 20 20", body: <><path d="M0.621992 6.52179C0.220039 7.60515 0 8.77683 0 10C0 11.2232 0.220039 12.395 0.621992 13.4783L10 14.3478L19.378 13.4783C19.78 12.395 20 11.2232 20 10C20 8.77683 19.78 7.60515 19.378 6.52179L10 5.65222L0.621992 6.52179Z" fill="#F0F0F0"/>
<path d="M9.99906 0C5.69945 0 2.03398 2.71375 0.621094 6.52176H19.3771C17.9641 2.71375 14.2987 0 9.99906 0Z" fill="#D80027"/>
