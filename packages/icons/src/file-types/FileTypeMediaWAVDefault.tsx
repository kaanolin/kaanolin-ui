...
export const FileTypeMediaWAVDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeMediaWAVDefault(
...
<rect x="1" y="18" width="30" height="16" rx="2" fill="#DB2777"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.15918" y="29.6364">WAV</tspan></text>
    </svg>
  );
});
FileTypeMediaWAVDefault.displayName = "FileTypeMediaWAVDefault";
