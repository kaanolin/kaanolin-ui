...
export const FileTypeDocumentDOCXDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDocumentDOCXDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.19531" y="29.6364">DOCX</tspan></text>
    </svg>
  );
});
FileTypeDocumentDOCXDefault.displayName = "FileTypeDocumentDOCXDefault";
