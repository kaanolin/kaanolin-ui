...
export const FileTypeMediaMP3Default = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeMediaMP3Default(
...
<rect x="1" y="18" width="29" height="16" rx="2" fill="#DB2777"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.3916" y="29.6364">MP3</tspan></text>
    </svg>
  );
});
FileTypeMediaMP3Default.displayName = "FileTypeMediaMP3Default";
