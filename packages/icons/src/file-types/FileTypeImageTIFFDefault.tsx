...
export const FileTypeImageTIFFDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageTIFFDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.40918" y="29.6364">TIFF</tspan></text>
    </svg>
  );
});
FileTypeImageTIFFDefault.displayName = "FileTypeImageTIFFDefault";
