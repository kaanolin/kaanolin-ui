...
export const FileTypeDesignINDDInDesignDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDesignINDDInDesignDefault(
...
<rect x="1" y="18" width="31" height="16" rx="2" fill="#C026D3"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.14648" y="29.6364">INDD</tspan></text>
    </svg>
  );
});
FileTypeDesignINDDInDesignDefault.displayName = "FileTypeDesignINDDInDesignDefault";
