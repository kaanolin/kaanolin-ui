...
export const FileTypeDocumentPPTXDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDocumentPPTXDefault(
...
<rect x="1" y="18" width="33" height="16" rx="2" fill="#EA580C"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.11133" y="29.6364">PPTX</tspan></text>
    </svg>
  );
});
FileTypeDocumentPPTXDefault.displayName = "FileTypeDocumentPPTXDefault";
