...
export const FileTypeDesignFIGFigmaDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDesignFIGFigmaDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.37012" y="29.6364">FIG</tspan></text>
    </svg>
  );
});
FileTypeDesignFIGFigmaDefault.displayName = "FileTypeDesignFIGFigmaDefault";
