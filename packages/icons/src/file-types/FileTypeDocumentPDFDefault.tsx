...
export const FileTypeDocumentPDFDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDocumentPDFDefault(
...
<rect x="1" y="18" width="26" height="16" rx="2" fill="#DC2626"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.2002" y="29.6364">PDF</tspan></text>
    </svg>
  );
});
FileTypeDocumentPDFDefault.displayName = "FileTypeDocumentPDFDefault";
