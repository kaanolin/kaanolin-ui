...
export const FileTypeSimpleEmptySolid = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeSimpleEmptySolid(
...
FileTypeSimpleEmptySolid.displayName = "FileTypeSimpleEmptySolid";
