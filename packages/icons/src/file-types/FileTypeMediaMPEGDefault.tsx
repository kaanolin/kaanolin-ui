...
export const FileTypeMediaMPEGDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeMediaMPEGDefault(
...
<rect x="1" y="18" width="36" height="16" rx="2" fill="#2563EB"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.32227" y="29.6364">MPEG</tspan></text>
    </svg>
  );
});
FileTypeMediaMPEGDefault.displayName = "FileTypeMediaMPEGDefault";
