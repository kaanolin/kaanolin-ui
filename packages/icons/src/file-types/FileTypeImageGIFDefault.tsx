...
export const FileTypeImageGIFDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageGIFDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.37012" y="29.6364">GIF</tspan></text>
    </svg>
  );
});
FileTypeImageGIFDefault.displayName = "FileTypeImageGIFDefault";
