...
export const FileTypeImageIMGDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageIMGDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.21973" y="29.6364">IMG</tspan></text>
    </svg>
  );
});
FileTypeImageIMGDefault.displayName = "FileTypeImageIMGDefault";
