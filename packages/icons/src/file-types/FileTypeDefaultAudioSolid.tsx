...
export const FileTypeDefaultAudioSolid = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDefaultAudioSolid(
...
FileTypeDefaultAudioSolid.displayName = "FileTypeDefaultAudioSolid";
