...
export const FileTypeImageEPSDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageEPSDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.4248" y="29.6364">EPS</tspan></text>
    </svg>
  );
});
FileTypeImageEPSDefault.displayName = "FileTypeImageEPSDefault";
