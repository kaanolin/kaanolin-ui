...
export const FileTypeImageJPGDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageJPGDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.10742" y="29.6364">JPG</tspan></text>
    </svg>
  );
});
FileTypeImageJPGDefault.displayName = "FileTypeImageJPGDefault";
