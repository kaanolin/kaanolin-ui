...
export const FileTypeMediaMKVDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeMediaMKVDefault(
...
<rect x="1" y="18" width="30" height="16" rx="2" fill="#2563EB"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.2373" y="29.6364">MKV</tspan></text>
    </svg>
  );
});
FileTypeMediaMKVDefault.displayName = "FileTypeMediaMKVDefault";
