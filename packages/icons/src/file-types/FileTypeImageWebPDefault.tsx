...
export const FileTypeImageWebPDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageWebPDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.21484" y="29.6364">WEBP</tspan></text>
    </svg>
  );
});
FileTypeImageWebPDefault.displayName = "FileTypeImageWebPDefault";
