...
export const FileTypeDocumentXLSXDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDocumentXLSXDefault(
...
<rect x="1" y="18" width="33" height="16" rx="2" fill="#16A34A"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.23828" y="29.6364">XLSX</tspan></text>
    </svg>
  );
});
FileTypeDocumentXLSXDefault.displayName = "FileTypeDocumentXLSXDefault";
