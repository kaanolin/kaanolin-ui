...
export const FileTypeImageJPEGDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageJPEGDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.0459" y="29.6364">JPEG</tspan></text>
    </svg>
  );
});
FileTypeImageJPEGDefault.displayName = "FileTypeImageJPEGDefault";
