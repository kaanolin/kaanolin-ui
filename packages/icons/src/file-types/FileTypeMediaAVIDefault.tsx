...
export const FileTypeMediaAVIDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeMediaAVIDefault(
...
<rect x="1" y="18" width="23" height="16" rx="2" fill="#2563EB"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.07227" y="29.6364">AVI</tspan></text>
    </svg>
  );
});
FileTypeMediaAVIDefault.displayName = "FileTypeMediaAVIDefault";
