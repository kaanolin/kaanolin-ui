...
export const FileTypeDefaultVideo02Solid = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDefaultVideo02Solid(
...
<g clipPath={`url(#${uid}-clip0_4916_414641)`}>
<path d="M20 30.6666C23.6819 30.6666 26.6667 27.6819 26.6667 24C26.6667 20.3181 23.6819 17.3333 20 17.3333C16.3181 17.3333 13.3334 20.3181 13.3334 24C13.3334 27.6819 16.3181 30.6666 20 30.6666Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<defs>
<clipPath id={`${uid}-clip0_4916_414641`}>
...
FileTypeDefaultVideo02Solid.displayName = "FileTypeDefaultVideo02Solid";
