...
export const FileTypeMediaMP4Default = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeMediaMP4Default(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.29883" y="29.6364">MP4</tspan></text>
    </svg>
  );
});
FileTypeMediaMP4Default.displayName = "FileTypeMediaMP4Default";
