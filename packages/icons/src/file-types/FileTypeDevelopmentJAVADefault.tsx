...
export const FileTypeDevelopmentJAVADefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDevelopmentJAVADefault(
...
<rect x="1" y="18" width="33" height="16" rx="2" fill="#4F46E5"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.36523" y="29.6364">JAVA</tspan></text>
    </svg>
  );
});
FileTypeDevelopmentJAVADefault.displayName = "FileTypeDevelopmentJAVADefault";
