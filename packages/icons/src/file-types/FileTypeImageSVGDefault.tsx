...
export const FileTypeImageSVGDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImageSVGDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.38477" y="29.6364">SVG</tspan></text>
    </svg>
  );
});
FileTypeImageSVGDefault.displayName = "FileTypeImageSVGDefault";
