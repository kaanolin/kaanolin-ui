...
export const FileTypeSimpleFolderSolid = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeSimpleFolderSolid(
...
FileTypeSimpleFolderSolid.displayName = "FileTypeSimpleFolderSolid";
