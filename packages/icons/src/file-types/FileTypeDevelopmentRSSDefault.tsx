...
export const FileTypeDevelopmentRSSDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDevelopmentRSSDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.16602" y="29.6364">RSS</tspan></text>
    </svg>
  );
});
FileTypeDevelopmentRSSDefault.displayName = "FileTypeDevelopmentRSSDefault";
