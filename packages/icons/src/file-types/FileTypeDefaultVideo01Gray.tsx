...
export const FileTypeDefaultVideo01Gray = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDefaultVideo01Gray(
  ...
  return (
    ...
    >
      ...
      <mask id={`${uid}-mask0_4916_412065`} style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="4" y="0" width="32" height="40">
<path d="M4 4C4 1.79086 5.79086 0 8 0H24L36 12V36C36 38.2091 34.2091 40 32 40H8C5.79086 40 4 38.2091 4 36V4Z" fill={`url(#${uid}-paint0_linear_4916_412065)`}/>
</mask>
<g mask={`url(#${uid}-mask0_4916_412065)`}>
...
<g clipPath={`url(#${uid}-clip0_4916_412065)`}>
...
<defs>
<linearGradient id={`${uid}-paint0_linear_4916_412065`} x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
<stop stopOpacity="0.4"/>
<stop offset="1"/>
</linearGradient>
<clipPath id={`${uid}-clip0_4916_412065`}>
...
FileTypeDefaultVideo01Gray.displayName = "FileTypeDefaultVideo01Gray";
