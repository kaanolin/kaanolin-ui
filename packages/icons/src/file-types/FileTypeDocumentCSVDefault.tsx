...
export const FileTypeDocumentCSVDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeDocumentCSVDefault(
...
<rect x="1" y="18" width="28" height="16" rx="2" fill="#16A34A"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.22363" y="29.6364">CSV</tspan></text>
    </svg>
  );
});
FileTypeDocumentCSVDefault.displayName = "FileTypeDocumentCSVDefault";
