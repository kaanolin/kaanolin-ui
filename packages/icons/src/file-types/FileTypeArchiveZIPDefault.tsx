...
export const FileTypeArchiveZIPDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeArchiveZIPDefault(
...
<rect x="1" y="18" width="22" height="16" rx="2" fill="#404040"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.02637" y="29.6364">ZIP</tspan></text>
    </svg>
  );
});
FileTypeArchiveZIPDefault.displayName = "FileTypeArchiveZIPDefault";
