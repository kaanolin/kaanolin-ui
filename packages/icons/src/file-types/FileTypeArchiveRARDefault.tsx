...
export const FileTypeArchiveRARDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeArchiveRARDefault(
...
<rect x="1" y="18" width="27" height="16" rx="2" fill="#404040"/>
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.19727" y="29.6364">RAR</tspan></text>
    </svg>
  );
});
FileTypeArchiveRARDefault.displayName = "FileTypeArchiveRARDefault";
