...
export const FileTypeImagePNGDefault = forwardRef<SVGSVGElement, IconBaseProps>(function FileTypeImagePNGDefault(
...
<text fill="white" style={{ whiteSpace: "pre" }} xmlSpace="preserve" fontFamily="Inter" fontSize="10" fontWeight="bold" letterSpacing="0em"><tspan x="4.28223" y="29.6364">PNG</tspan></text>
    </svg>
  );
});
FileTypeImagePNGDefault.displayName = "FileTypeImagePNGDefault";
