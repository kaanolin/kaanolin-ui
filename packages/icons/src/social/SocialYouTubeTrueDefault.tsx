...
export const SocialYouTubeTrueDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialYouTubeTrueDefault(
...
SocialYouTubeTrueDefault.displayName = "SocialYouTubeTrueDefault";
