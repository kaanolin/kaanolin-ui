...
export const SocialPinterestFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialPinterestFalseDefault(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_1027_1541)`}>
...
<defs>
<clipPath id={`${uid}-clip0_1027_1541`}>
...
SocialPinterestFalseDefault.displayName = "SocialPinterestFalseDefault";
