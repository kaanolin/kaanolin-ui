...
export const SocialClubhouseFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialClubhouseFalseDefault(
...
SocialClubhouseFalseDefault.displayName = "SocialClubhouseFalseDefault";
