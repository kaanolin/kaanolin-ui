...
export const SocialSpotifyTrueDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialSpotifyTrueDefault(
...
SocialSpotifyTrueDefault.displayName = "SocialSpotifyTrueDefault";
