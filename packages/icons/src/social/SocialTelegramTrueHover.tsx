...
export const SocialTelegramTrueHover = forwardRef<SVGSVGElement, IconBaseProps>(function SocialTelegramTrueHover(
...
SocialTelegramTrueHover.displayName = "SocialTelegramTrueHover";
