...
export const SocialYouTubeFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialYouTubeFalseDefault(
...
SocialYouTubeFalseDefault.displayName = "SocialYouTubeFalseDefault";
