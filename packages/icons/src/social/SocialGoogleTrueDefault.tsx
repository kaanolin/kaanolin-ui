...
export const SocialGoogleTrueDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialGoogleTrueDefault(
...
SocialGoogleTrueDefault.displayName = "SocialGoogleTrueDefault";
