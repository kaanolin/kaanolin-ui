...
export const SocialGoogleTrueHover = forwardRef<SVGSVGElement, IconBaseProps>(function SocialGoogleTrueHover(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_1459_241914)`}>
...
<defs>
<clipPath id={`${uid}-clip0_1459_241914`}>
...
SocialGoogleTrueHover.displayName = "SocialGoogleTrueHover";
