...
export const SocialWebflowFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialWebflowFalseDefault(
...
SocialWebflowFalseDefault.displayName = "SocialWebflowFalseDefault";
