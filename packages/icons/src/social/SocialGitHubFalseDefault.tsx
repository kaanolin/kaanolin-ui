...
export const SocialGitHubFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialGitHubFalseDefault(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_1507_257970)`}>
...
<defs>
<clipPath id={`${uid}-clip0_1507_257970`}>
...
SocialGitHubFalseDefault.displayName = "SocialGitHubFalseDefault";
