...
export const SocialGoogleFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialGoogleFalseDefault(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_1027_1528)`}>
...
<defs>
<clipPath id={`${uid}-clip0_1027_1528`}>
...
SocialGoogleFalseDefault.displayName = "SocialGoogleFalseDefault";
