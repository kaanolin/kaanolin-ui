...
export const SocialTelegramFalseDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialTelegramFalseDefault(
...
SocialTelegramFalseDefault.displayName = "SocialTelegramFalseDefault";
