...
export const SocialSpotifyTrueHover = forwardRef<SVGSVGElement, IconBaseProps>(function SocialSpotifyTrueHover(
...
SocialSpotifyTrueHover.displayName = "SocialSpotifyTrueHover";
