...
export const SocialWiseTrueDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialWiseTrueDefault(
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${uid}-clip0_9337_588379)`}>
...
<defs>
<clipPath id={`${uid}-clip0_9337_588379`}>
...
SocialWiseTrueDefault.displayName = "SocialWiseTrueDefault";
