...
export const SocialYouTubeTrueHover = forwardRef<SVGSVGElement, IconBaseProps>(function SocialYouTubeTrueHover(
...
SocialYouTubeTrueHover.displayName = "SocialYouTubeTrueHover";
