...
export const SocialTelegramTrueDefault = forwardRef<SVGSVGElement, IconBaseProps>(function SocialTelegramTrueDefault(
...
SocialTelegramTrueDefault.displayName = "SocialTelegramTrueDefault";
