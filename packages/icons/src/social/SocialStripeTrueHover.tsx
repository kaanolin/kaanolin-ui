...
export const SocialStripeTrueHover = forwardRef<SVGSVGElement, IconBaseProps>(function SocialStripeTrueHover(
...
SocialStripeTrueHover.displayName = "SocialStripeTrueHover";
